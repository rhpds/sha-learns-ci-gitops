# Reference Example: Descheduler Operator README

This is the complete expected output for the descheduler workload. Use it as a reference when generating documentation for other workloads.
